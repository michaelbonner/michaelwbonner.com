...
const AboutDesc = styled.p`
  ${tw(
    "text-grey-light text-lg md:text-xl lg:text-2xl font-sans pt-6 md:pt-12"
  )};
`;
    ...
    <Parallax pages={5}>
      ...
      <Content speed={0.4} offset={1.2} factor={2}>
        <Inner>
          ...
          <ProjectsWrapper>
            ...
            >
              My friend Jeff Moore built some awesome software to help
              businesses manage their GRC needs. Go check it out.
            </ProjectCard>
            <ProjectCard
            ...
            >
              Need a window well cover in Utah? Go buy a custom one from Wasatch
              Covers
            </ProjectCard>
            <ProjectCard
              title="Quiznado"
            ...
            >
              A quiz game for parents to incentivize kids to learn. Built using
              Angular, Ionic and Laravel.
            </ProjectCard>
            <ProjectCard
              title="Legit Local"
            ...
            >
              A SaaS application to help local businesses to connect with their
              customers. Built with Laravel and React.
            </ProjectCard>
            <ProjectCard
            ...
            >
              A tool to help find and address 404s, even before the site goes
              live. Built with Laravel and Vue.
            </ProjectCard>
            <ProjectCard
            ...
            >
              An app to keep track of which sites are up, and the SSL status of
              each. Built with Laravel.
            </ProjectCard>
          </ProjectsWrapper>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={3}>
        <Inner>
          ...
          <AboutHero>
            ...
            <AboutSub>
              A web and software developer based in Salt Lake, UT.
            </AboutSub>
          </AboutHero>
          <AboutDesc>
            Over 15 years of development experience, and 5 years of director
            level agency experience. I know what works, what doesn't work, and
            why. I can use that knowledge to build you a site, mobile app, or
            software that works for your needs. I'll sit with you and your team,
            we'll make a plan, and we'll build some awesome stuff.
          </AboutDesc>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={4}>
        ...
        <Footer>
          ...
          <a href="https://github.com/michaelbonner/michaelwbonner.com">
            Github
          </a>
          .
        </Footer>
